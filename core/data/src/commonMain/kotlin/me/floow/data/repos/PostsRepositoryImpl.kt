...
class PostsRepositoryImpl(
	...
	override suspend fun getUserPosts(
		...
		return when (
			...
			is GetUserPostsResponse.Success -> GetDataResponse.Success(response.posts.map { item -> item.toDomainPost() })
	...
	override suspend fun deletePost(postId: String): UpdateDataResponse {
		...
		return if (result) UpdateDataResponse.Success else UpdateDataResponse.Failure(FailureError.Other)
	}
